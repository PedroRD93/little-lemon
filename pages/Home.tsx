...
import { createTable, filterDishes, getMenuItems, getMenuItemsByCategory, saveMenuItems } from "../database";
...
export const Home = () => {
    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                const uniqueCategories: string[] = [...new Set(menuItems.map((item: any): string => item.category))] as string[];
    ...
    return (
        <View style={styles.container}>
            ...
            <MainBanner>
                <SearchInput value={filteredText} onChange={setFilteredText} placeholder="Search" label={"Search"} />
            </MainBanner>
            <View style={styles.menuContainer}>
                <Text style={styles.title}>Order for Delivery!</Text>
                <View style={styles.categoryContainer}>
                    <CategoriesList categories={categoriesMenu} onCategorySelect={handleCategorySelect} />
                </View>
                <FlatList
                    data={data}
                    ...
                    renderItem={({ item }) => <MenuItemCard item={item} key={item.id} />}
                />
            </View>
        </View>
    );
